...
def run(data,
        ...
        half=False,  # use FP16 half-precision inference (改ACmix)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp71/weights/best.pt', help='model.pt path(s)')
